...
def main():
    ...
    disagreements = [c["id"] for a, c in zip(v1, cases) if a != c["human_label"]]

    print("Track E docs-answer judge validation - V1")
    ...
    print(f"disagreements ({len(disagreements)}): {', '.join(disagreements)}")
    print("\nArtifact: judge_v1.txt")

...
import { ArrowRight, BadgeCheck, ChevronDown, FlaskConical, Gauge, ShieldCheck, Sparkles, Target } from 'lucide-react'
...
export default function JudgeValidationPanel({ data }) {
  ...
  return (
    <motion.div
      className="insight-card card tone-0"
    ...
    >
      ...
      >
        ...
        <div className="insight-row-text">
          <div className="insight-row-eyebrow">Week 6 · Task Set E</div>
          <div className="insight-row-title">Docs-Answer Judge Validation</div>
        </div>
        <div className="insight-row-stats">
          <div className="insight-stat"><b>{before.pct}%</b><span>Judge V1</span></div>
          <div className="insight-stat"><b>{after.pct}%</b><span>Judge V2</span></div>
        </div>
        ...
        {open && (
          ...
          >
            ...
            <div className="insight-body-inner">
              ...
              <div className="judge-panel-badges-inline">
